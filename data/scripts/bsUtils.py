...
_gPlayerColors = [
    (4, 0.15, 0.15), (0.2, 1, 0.2), (0.1, 0.1, 1), (0.2, 9, 9),
    (0.5, 0.25, 1.0), (1, 1, 0), (1, 0.5, 0), (1, 0.3, 0.5),
    (0.1, 0.1, 0.5), (0.4, 0.2, 0.1), (0.1, 0.35, 0.1), (3, 1.8, 1.5),
    (9.4, 2.05, 2.05), (0.13, 0.13, 0.13), (0.1, 0.1, 0.1), (9, 9, 9)]
gMusic = None
_gConfig = None
...
class Background(bsGame.Actor):
    ...
    def __init__(self, fadeTime=500, startFaded=False, showLogo=False):
        ...
        with bs.Context(session):
            ...
            if showLogo:
                logoTexture = bs.getTexture('graphicsIcon')
