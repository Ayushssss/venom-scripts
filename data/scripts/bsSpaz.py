        ...
        if isinstance(msg, bs.PickedUpMessage):
            ...
            if msg.hitType == 'punch':
                ...
                if damage >= 800 and damage <= 99999:
                    bsUtils.PopupText(u"\ue048#FIRE!\ue048",color=((0+random.random()*1.0),(0+random.random()*1.0),(0+random.random()*1.0)),scale=1.6,position=self.node.position).autoRetain()
                elif damage >= 700 and damage < 800:
                    bsUtils.PopupText(u"\ue048IMPRESSIVE\ue048",color=(0.2,1,0.2),scale=1.6,position=self.node.position).autoRetain()
                elif damage >= 600 and damage < 700:
                    bsUtils.PopupText(u"\ue048AWESOME\ue048",color=(0.2,1,0.2),scale=1.6,position=self.node.position).autoRetain()
               
                elif damage >= 500 and damage < 600:
                    bsUtils.PopupText(u"\ue048WELL DONE\ue048",color=(0.2,1,0.2),scale=1.6,position=self.node.position).autoRetain()             
                elif damage >= 400 and damage < 500:
                    bsUtils.PopupText(u"\ue048NICE ONE\ue048",color=(0.2,1,0.2),scale=1.6,position=self.node.position).autoRetain()
                elif damage >= 300 and damage < 400:
                    bsUtils.PopupText(u"\ue048PRO\ue048",color=(0.2,1,0.2),scale=1.6,position=self.node.position).autoRetain()
                elif damage >= 200 and damage < 300:
                    bsUtils.PopupText(u"\ue048GOOD!!\ue048",color=(0.2,1,0.2),scale=1.6,position=self.node.position).autoRetain()
                elif damage >= 100 and damage < 200:
                    bsUtils.PopupText(u"\ue048COOL\ue048",color=(0.2,1,0.2),scale=1.6,position=self.node.position).autoRetain()
                elif damage > 0 and damage < 100:
                    bsUtils.PopupText(u"\ue048GOOD JOB\ue048",color=(0.2,1,0.2),scale=1.6,position=self.node.position).autoRetain()
