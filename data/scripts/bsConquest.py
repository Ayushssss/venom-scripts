...
class ConquestGame(bs.TeamGameActivity):
    ...
    def onTransitionIn(self):
        ...
        if not bs.getEnvironment().get('toolbarTest',True):
            ...
            bs.animate(self.p_image.node, 'opacity', {0:0, 200:1.00})
            bsUtils.animate(self.p_image.node,'rotate',{90000:7000,1000:360},loop=True)
            
            text3 = bs.getTexture('achievementCrossHair')
            self.pc_image = bs.NodeActor(
                bs.newNode('image',
                           attrs={'texture':text3,
                                  'tintColor':(0,0,1),
                                  'tint2Color':(0,0,1),
                                  ...
                                  'opacity':1.0,
                                  'absoluteScale':True}))
            bs.animate(self.pc_image.node, 'opacity', {0:0, 200:1.00})
            bsUtils.animate(self.pc_image.node,'rotate',{90000:7000,1000:360},loop=True)
            
            text4 = bs.getTexture('achievementCrossHair')
            self.pc1_image = bs.NodeActor(
                bs.newNode('image',
                           attrs={'texture':text4,
                                  'tintColor':(0,0,1),
                                  'tint2Color':(0,0,1),
                                  ...
                                  'opacity':1.0,
                                  'absoluteScale':True}))
            bs.animate(self.pc1_image.node, 'opacity', {0:0, 200:1.00})
            bsUtils.animate(self.pc1_image.node,'rotate',{90000:7000,1000:360},loop=True)           
           
            text = bs.getTexture('logo')
            self.p1_image = bs.NodeActor(
                bs.newNode('image',
                           attrs={'texture':text,
                                  'tintColor':(0,0,1),
                                  'tint2Color':(0,0,1),
                                  ...
                                  'opacity':1.0,
                                  'absoluteScale':True}))
            bs.animate(self.p1_image.node, 'opacity', {0:0, 200:1.00})
            bsUtils.animate(self.p1_image.node,'rotate',{90000:7000,1000:360},loop=True)
